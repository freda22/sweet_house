          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form" data-toggle="validator">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="name" data-error="請填寫姓名" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
                  <label for="memberID" class="control-label">帳號</label>
                </div>
                <div class="col-sm-10">
                  <label for="memberID" class="control-label">andy1225</label>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
