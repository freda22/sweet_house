...
$sth = $db->query("SELECT * FROM product_category WHERE categoryID=".$_GET['categoryID']);
          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form" method="post" action="edit.php">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="category" name="category" value="<?php echo $product_category['category'];?>">
                </div>
              </div>
